...
DT = (function(){
    ...
    today = function(){ 
        var t = new Date();
        var today = new Date(t.getFullYear(), t.getMonth(), t.getDate(), 0, 0, 0, 0);
        return today; 
    };
    
    spot = function(){ return tPlusDate(today(), 2) }
    ...
    dateAPI.isWeekend = function(day){ return isWeekend(day) };
    dateAPI.isHoliday = function(day){ return isHoliday(day) };
    dateAPI.isLastDayOfMonth = function(day){ return isLastDayOfMonth(day) };
    dateAPI.today = function(){ return today() };
    dateAPI.spot = function(){ return spot() };
    dateAPI.tPlusDate = function(date, offset){ return tPlusDate(date, offset) };
    dateAPI.mfDate = function(date){ return mfDate(date) };
    dateAPI.easter = function(Y){ return easter(Y)}
